...
**O que é um Magic Number:** Números mágicos são valores contidos em um código sem uma definição clara de seu significado, muita das vezes apenas o desenvolvedor da regra de negócios entende. Sendo assim, definimos como constante para que fique centralizado esse valor.
